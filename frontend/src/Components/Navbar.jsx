...
// export default Navbar;
  ...
  const Navbar = () => {
    ...
    const menuItems = [
        { icon: <CottageIcon style={{ fontSize: '28px' }} />, label: 'Home', key: 'hoveHome' },
        { icon: <ExploreIcon style={{ fontSize: '28px' }} />, label: 'Explore', key: 'hovExp' },
        { icon: <AddCircleIcon style={{ fontSize: '28px' }} />, label: 'Post', key: 'hovPost' },
        { icon: <DashboardIcon style={{ fontSize: '28px' }} />, label: 'Tabs', key: 'hovTabs' },
        { icon: <SendIcon style={{ fontSize: '28px' }} />, label: 'Messages', key: 'hovMess' },
        { icon: <Face3Icon style={{ fontSize: '28px' }} />, label: 'Profile', key: 'hovProf' },
