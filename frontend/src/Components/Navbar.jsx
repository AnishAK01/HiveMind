...
import UploadModal from './UploadModal'; // <- make sure this path is correct

const Navbar = () => {
  const [showUploadModal, setShowUploadModal] = useState(false); // ✅ declare here
  ...
  const menuItems = [
    ...
    {
      icon: <img src=" \Minor project\plus.png" alt="" />,
      label: 'Upload Post',
      key: 'hovPost',
      action: () => setShowUploadModal(true) // ✅ use this instead of `path`
    },
